...
<config_machines version="2.0">
  ...
  <machine MACH="spock">
    ...
    <OS>CNL</OS>
    <COMPILERS>cray</COMPILERS>
    <MPILIBS>mpich</MPILIBS>
    <PROJECT>cli133</PROJECT>
    <SAVE_TIMING_DIR>/global/cfs/cdirs/e3sm</SAVE_TIMING_DIR>
    <SAVE_TIMING_DIR_PROJECTS>cli133</SAVE_TIMING_DIR_PROJECTS>
    ...
    <module_system type="module" allow_error="true">
      ...
      <modules>
        ...
        <command name="load">cray-python/3.8.5.0</command>
        <command name="load">PrgEnv-cray/8.1.0</command>
        <command name="swap">cce cce/12.0.0</command>
        <command name="load">cray-hdf5/1.12.0.4</command>
        <command name="load">cray-netcdf/4.7.4.3</command>
        <command name="load">cray-parallel-netcdf/1.12.1.3</command>
